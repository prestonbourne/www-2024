...
export const Home = () => {
  return (
    <>
      ...
      <Main>
        <Body>
          I earned my Bachelor&rsquo;s degree in Design & Technology from{" "}
          <Link
          ...
          . In my final year, I had the privilege of studying as an exchange
          student at{" "}
          <Link href={"https://tech.cornell.edu/"} target="_blank">
            Cornell University
          </Link>
          &nbsp;where I worked with MS and MBA students under a Ph.D. mentor
          from Microsoft Azure. We iterated on solutions to productionize LLMs
        ...
        <Body>
          ...
          and received an offer to return as a full-time Engineer on the Web
          Infrastructure and Platforms team, where I work to this day.
        </Body>
        <Body>
        ...
        <Body>
          ...
          and online profiles. If you have questions about how I built or advice
          on how to improve something, don&rsquo;t hesitate to reach out.
        </Body>
        <hr className="my-4" />
        <Body>
          <Link
